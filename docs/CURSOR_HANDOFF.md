...
4. **Pictures**: the week as bars (green free, grey work, no numbers), a day as a strip plus a list of blocks. A picture is always its own bubble, sent before the words.
