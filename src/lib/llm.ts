...
- "reserve friday evening" puts a block called "Reserved for you" on the calendar: no work goes there, and it is the first place Buffer suggests people time (plan people time, the evening nudge).
...
- "clear my day" / "clear my schedule tomorrow" asks whether to clear everything or only the work, then does it; "undo" puts it back.
- It remembers when you were last in touch with each person ("called mum", "had dinner with rohan yesterday", or a saved plan that has passed) and nudges about whoever it has been longest. "who do i call" lists people with days since. On WhatsApp, sharing a person's contact card (or "mum's number is +91...") lets the nudge open that chat in one tap.
- Once a day, in the three hours after your switch-off time, if nothing is on, it nudges you to call one of your people ("nudge me to call mum" adds someone; "who do i call" lists them; "nudges off" stops them). On WhatsApp the nudge is a message; in the web chat it can also be a browser notification.
...
- todos: list to-dos. overlaps: clashes. status: "how am i doing", burnout talk. calendar: anything about getting things into their calendar app ("add it to gcal", "put this in my google calendar", "sync to google", "connect calendar", "add to calendar"); Buffer answers with the Add to Google Cal button for the last thing saved. options: asks for the menu. help: "how does this work" with no specific question.
